...
export function RevokeTokenModal({ open, tokenName, onClose, onConfirm, isLoading = false }: RevokeTokenModalProps) {
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                      <div style={{
                        ...
                        <ShieldOff size={14} style={{ color: C.danger }} />
                      </div>
                      <div>
                        ...
                        <p style={{ fontSize: 11, color: C.textSubtle, fontFamily: "'Inter', sans-serif", fontFeatureSettings: '"cv01","ss03"', marginTop: 2 }}>
                          {tokenName}
                        </p>
                      </div>
                    </div>
                    ...
                    <div style={{ padding: '20px 24px' }}>
                      <div style={{
                        ...
                        <p style={{ fontSize: 12, color: '#fca5a5', fontFamily: "'Inter', sans-serif", fontFeatureSettings: '"cv01","ss03"', lineHeight: 1.5 }}>
                          Any services using this token will immediately lose access. This cannot be undone.
                        </p>
                      </div>
                    </div>
